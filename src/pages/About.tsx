					...
					<ul className='flex flex-wrap items-center justify-center gap-4'>
						{navItems.map((item, index) => (
							<li
								...
								{index < navItems.length - 1 && <span className='text-blue-600 mx-4'>|</span>}
							</li>
						))}
					</ul>
				</div>
			...
			<Section
				...
				<div className='grid grid-cols-1 lg:grid-cols-2 gap-8'>
					...
					<div className='space-y-6'>
						...
						<p className='text-gray-600 leading-relaxed'>
							We provide custom solutions across the supply chain, including inbound transportation, finished vehicle logistics, IT services, and business intelligence. Our ISO 9001:2015 certified Quality Management System ensures our
							solutions meet high standards.
						</p>
						<p className='text-gray-600 leading-relaxed'>Combining expertise, integrity, and ethical standards, we deliver total confidence in our solutions to help clients reduce costs and optimize their supply chain.</p>
					</div>
				...
				<div className='mt-12'>
					<div className='flex flex-col lg:flex-row items-center justify-between gap-6'>
						<h2 className='text-2xl font-bold text-gray-800 max-w-3xl'>Contact us to find the right customized solution for your business!</h2>
						<Button
							size='lg'
