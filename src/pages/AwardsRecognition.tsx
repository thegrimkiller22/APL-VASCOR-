...
const AwardsRecognition = () => {
	return (
		<section className='bg-white py-20 mt-48 px-6 md:px-16'>
			{/* Header Section */}
			<h1 className='text-5xl font-extrabold text-blue-900 leading-tight md:text-6xl text-center mb-32'>Awards and Recognition</h1>
					...
					<p className='text-gray-500 text-lg leading-relaxed text-left'>
						<ul>
							...
							<li>
								...
								has been awarded as the ‘Best 3PL Company of the Year (Automotive)' at Inflection Awards 2018!
							</li>
							<li>
								<strong>
									<a
								...
								has been awarded as the 'Best Rail Freight Company of the Year' at Global Logistics Excellence Awards by CNBC Network 18.
							</li>
							<li>
								<strong>
									<a
							...
							<li>
								...
								invests in high-capacity rakes, gears up new rail-based offering for finished vehicles in India
							</li>
							<li>
								<strong>
									<a
			...
			<div className='grid grid-cols-2 w-full '>
				<div className='px-6 py-16 order-2'>
					...
					<p>
						{' '}
						APL Logistics VASCOR Automotive has been a key player in the logistics and supply chain industry, offering innovative solutions for automotive transportation. This case study outlines their approach to enhancing operational
						efficiency and improving logistics performance. Through their strategic initiatives and investment in cutting-edge technology, APL Logistics VASCOR Automotive has made significant strides in the automotive logistics sector.{' '}
					</p>
					<br></br>
